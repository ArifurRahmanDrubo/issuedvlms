                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <select class="form-control form_input" id="update_vehicle_name">
                                ...
                                <select class="form-control form_input" id="update_service_type_name">
                                    <option value="">Select Service Type</option>
                                </select>

                                <label class="form-label">Service Provider </label>
                                <select class="form-control form_input" id="update_service_provider_name">
...
async function FillUpUpdateForm(id) {
    try {
        ...
        document.getElementById('update_service_type_id').value = data.service_type_name;
        document.getElementById('update_service_provider_id').value = data.service_provider_name;
...
async function Update() {
    try {
        ...
        if (vehicle_id.length === 0) {
            ...
            errorToast("Service Type  Required!");
