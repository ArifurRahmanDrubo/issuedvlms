                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <select class="form-control form_input" id="service_provider_name">
...
async function getServiceProviderList() {
    try {
        ...
        const select = document.getElementById('service_provider_name');
...
async function Save() {
    try {
        ...
        let service_provider_name = document.getElementById('service_provider_name').value;
        ...
        } else if (service_provider_name.length === 0) {
            errorToast("Service Provider ID Required!");
        } else {
            let formData = new FormData();

            formData.append('service_name', service_name);
            formData.append('service_provider_name', service_provider_name);
